...
const { ServerIPAddress, ServerPort, FetchInterval, OWMChartData30DayEndpointSuffix, OWMTempChartTitle } = config;
...
const OWMTempChart30Day = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await axios.get(`http://${ServerIPAddress}:${ServerPort}/${OWMChartData30DayEndpointSuffix}`);
...
// TODO: Change control name
export default OWMTempChart30Day;
