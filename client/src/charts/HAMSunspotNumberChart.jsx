...
const { ServerIPAddress, ServerPort, FetchInterval, HamConditionsChartDataEndpointSuffix, HamSunspotNumberChartTitle } = config;
...
const HAMSunspotNumberChart = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await axios.get(`http://${ServerIPAddress}:${ServerPort}/${HamConditionsChartDataEndpointSuffix}`);
