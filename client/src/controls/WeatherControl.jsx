  ...
  return (
    <div className="container mx-auto mt-8">
      <div className="flex">
        ...
        <button className={`flex-1 py-2 px-4 border-b-2 ${activeTab === 3 ? "border-blue-500 text-blue-500" : "border-gray-300 text-gray-500"} focus:outline-none`} onClick={() => handleTabClick(3)}>Weather Charts</button>
      </div>

      <div className="tab-content mt-4">
        {activeTab === 1 && <WeatherConditions />}
        {activeTab === 2 && <OWMConditions />}
        {activeTab === 3 && <div><OWMTempChart /> <br /> <OWMCloudinessChart /></div>}
      </div>
    </div>
  );
};
